...
class MailMessage(models.Model):
    ...
    def tracking_status(self):
        """Flag each recipient as Cc/Bcc using the partner-based
        recipient_cc_ids / recipient_bcc_ids (authoritative, set by the mail
        composer). Recipients themselves are already listed by super() through
